...
CLS
PRINT "** Magazine Collection Search **"
PRINT
PRINT "You can enter a title (or partial title) and I'll find the rest"
INPUT "What title do you want to see"; search$
