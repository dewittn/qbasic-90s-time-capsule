    ...
    DO
        ...
        DO
            ...
            IF nonum = true THEN
                ...
                LOOP UNTIL NOT PointIsThere(numberRow, NumberCol, colorTable(4)) AND NOT PointIsThere(sisterRow, NumberCol, colorTable(4)) AND NOT PointIsThere(spcRow, spcCol, colorTable(4)) AND NOT PointIsThere(spisterRow, spcCol, colorTable(4))
            ...
            FOR a = 1 TO NumPlayers
                ...
                IF inv = true THEN
                IF sammy(a).col < 1 THEN sammy(a).col = 80: GOTO here
                IF sammy(a).col > 79 THEN sammy(a).col = 1
here:
